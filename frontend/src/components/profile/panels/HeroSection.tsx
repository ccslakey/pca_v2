    ...
    <div className="hero">
      ...
      <div className="hero-mid">
        ...
        <div className="hero-meta">
          <span>
            <span className="label">Pos</span> {player.pos}
          </span>
          <span className="sep">·</span>
          <span>
            <span className="label">Active</span> {player.years}
          </span>
          <span className="sep">·</span>
          <span>
            <span className="label">Seasons</span> {player.seasons.length}
          </span>
          {peak && (
            <>
              <span className="sep">·</span>
              <span>
                <span className="label">Peak WAR</span> {peak.val.toFixed(1)} (
                {peak.season})
              </span>
            </>
          )}
